...
public enum DepotID {
    ...
    LEADER1_DEPOT(DepotType.LEADER_DEPOT, SourceType.ANY, 0), LEADER2_DEPOT(DepotType.LEADER_DEPOT, SourceType.ANY, 1),
    LEADER1_PRODUCTION(DepotType.LEADER_PRODUCTION, SourceType.STRONGBOX, 0), LEADER2_PRODUCTION(DepotType.LEADER_PRODUCTION, SourceType.STRONGBOX, 1),
